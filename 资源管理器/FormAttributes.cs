    ...
    public partial class FormAttributes : Form
    {
        public FormAttributes(string path)
        {
            ...
            else if (File.Exists(path))
            {
                ...
                this.FileLength = (file.Length / (1024 * 1024)).ToString(CultureInfo.CurrentCulture) + "兆" + "\n" + "/" + file.Length.ToString(CultureInfo.CurrentCulture) + "字节";
            }
            this.Show();
